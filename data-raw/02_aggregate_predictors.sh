#! /usr/bin/bash -l
#SBATCH --job-name="FORHYX_aggregate_predictors"
...
#SBATCH --cpus-per-task=48     # nr of threads, used for shared memory jobs that run locally on a single compute node (default: 1)
